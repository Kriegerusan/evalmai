...
switch (true) {
    ...
    default:
        $inputDatas['postal'] = $_POST['postal'];
        $inputDatas['title'] = trim($_POST['title']);
        $inputDatas['address'] = trim($_POST['address']);
        $inputDatas['city'] = trim($_POST['city']);
        $inputDatas['description'] = trim($_POST['description']);
        $inputDatas['type'] = $_POST['type'];
        $inputDatas['price'] = round((float)ConvertStringFloat($_POST['price']), 0, PHP_ROUND_HALF_UP);
